import { ArrowLeft, FileText, Settings, Shield, LogOut, User, Mail, Phone, MapPin, Calendar } from 'lucide-react';
import type { User } from '../../App';
import { toast } from 'sonner@2.0.3';

interface BFPProfileProps {
  user: User;
  onLogout: () => void;
  onNavigate: (page: 'reports' | 'settings' | 'privacy') => void;
}

export function BFPProfile({ user, onLogout, onNavigate }: BFPProfileProps) {
  const handleLogout = () => {
